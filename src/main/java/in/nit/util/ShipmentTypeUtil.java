...
public class ShipmentTypeUtil {
	...
	public void generatePie(String path, List<Object[]> data) {
		...
		JFreeChart chart = ChartFactory.createPieChart3D("shipmentTypeModules", dataset, true, true, false);
	...
	public void generateBar(String path,List<Object[]> data) {
		...
		//create Jfreechart using chartfactory
		JFreeChart chart = ChartFactory.createBarChart("shipmentTypeModules","modes","count",dataset);
		//save as image using chartUtil
		try {
