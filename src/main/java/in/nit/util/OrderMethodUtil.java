...
public class OrderMethodUtil {
	...
	public void generatePie(String path, List<Object[]> data) {
		...
		JFreeChart chart = ChartFactory.createPieChart3D("OrderMethod", dataset, true, true, false);
	...
	public void generateBar(String path,List<Object[]> data) {
		...
		//create Jfreechart using chartfactory
		JFreeChart chart = ChartFactory.createBarChart("OrderMethod","modes","count",dataset);
		//save as image using chartUtil
		try {
